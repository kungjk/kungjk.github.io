            ...
            $.post(ajax_object.ajaxurl, {
                ...
                if(reponse == 'true'){
                    ...
                    if(paypal_active == 1){
                        ...
                        // Go to Paypal
                        var link_paypal = 'https://web.archive.org/web/20170606203516/https://www.sandbox.paypal.com/cgi-bin/webscr';
                        var paypal_environment = formnew.find('.input-register_environment').val();
                        if(paypal_environment == 1){
                            link_paypal = "https://web.archive.org/web/20170606203516/https://www.paypal.com/cgi-bin/webscr";
                        }else{
                            link_paypal = "https://web.archive.org/web/20170606203516/https://www.sandbox.paypal.com/cgi-bin/webscr";
                        }
...
/*
     FILE ARCHIVED ON 20:35:16 Jun 06, 2017 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 11:47:42 Jan 25, 2019.
...
/*
playback timings (ms):
  LoadShardBlock: 90.399 (3)
  esindex: 0.006
  captures_list: 114.829
  CDXLines.iter: 13.258 (3)
  PetaboxLoader3.datanode: 100.109 (4)
  exclusion.robots: 0.185
  exclusion.robots.policy: 0.171
  RedisCDXSource: 2.616
  PetaboxLoader3.resolve: 35.332 (2)
  load_resource: 94.615
*/